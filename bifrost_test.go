...
var (
	t1X, _ = big.NewInt(0).SetString("59836456643741183269835176751095743515395817285058468900383880677655616972226", 10)
	t1Y, _ = big.NewInt(0).SetString("35068856771725771339387917164601956621562646129885199575367583771781073078262", 10)
)
